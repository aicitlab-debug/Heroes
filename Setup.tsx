          ...
          <div className="min-h-full flex items-center justify-center p-4 pb-32 md:pb-24">
            ...
            <div className="max-w-[900px] w-full bg-white p-4 md:p-5 rotate-1 border-[6px] border-black shadow-[12px_12px_0px_rgba(0,0,0,0.6)] text-center relative">
                ...
                {typeof window !== 'undefined' && window.aistudio?.openSelectKey && (
                    <button onClick={() => window.aistudio?.openSelectKey()} className="comic-btn bg-gray-900 border-2 border-white/20 text-yellow-400 text-lg px-4 py-2 mb-4 w-full hover:bg-gray-800 uppercase tracking-widest flex items-center justify-center gap-2">
                        ★ Add Paid API Key for Unlimited Generation ★
                    </button>
                )}
